...
| Option | Method | Mô tả | Source |
|--------|--------|-------|--------|
| `off` | Không cài | Mặc định | — |
| `reregister` | `wsreset -i` | Cách đơn giản nhất cho Server 2025, đợi 30s rồi re-register | [Gist](https://gist.github.com/valorad/0b4aae69f57c3d6de144fc30d33fa9c2) |
| `ltsc-script` | LTSC Script | Tải script `Add-Store.cmd` từ GitHub (3.9k ⭐), chạy tự động | [GitHub](https://github.com/kkkgo/LTSC-Add-MicrosoftStore) |
| `manual-cdn` | CDN + DISM | Cài VCLibs từ [aka.ms](https://aka.ms/Microsoft.VCLibs.x64.14.00.Desktop.appx), DISM Add-Capability, wsreset -i | [Microsoft CDN](https://aka.ms/Microsoft.VCLibs.x64.14.00.Desktop.appx) |
